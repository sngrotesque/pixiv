...
pixiv.MultiThreadGetArtworks(ArtistID) # 获取指定用户的所有作品页与作品中所有图片的下载链接
pixiv.RESULTS_ArtworkLinks  # 所有作品页保存在此处
pixiv.RESULTS_PictureLinks  # 所有图片的下载链接保存在此处

url = [
    'https://www.pixiv.net/artworks/00000000',
    'https://www.pixiv.net/artworks/00000000',
    'https://www.pixiv.net/artworks/00000000'
]
folder = 'd:/123123'

pixiv.MultiThreadDownloadArtwork(url, folder) # 将作品列表分别下载保存至指定文件夹
